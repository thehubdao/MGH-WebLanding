  ...
  return (
    <>
      <main className="pt-4">
        ...
        <div className="flex flex-col xl:flex-row mb-0 xl:mb-16 gap-8 font-neueExtended">
          <div className=" w-full xl:w-1/4 pl-10 lg:pl-20 2xl:pl-36 ">
            ...
            <p className="text-4xl text-lm_icons font-bold">JOIN US</p>
          </div>
          <div className=" w-full xl:w-3/4 pr-10 lg:pr-20 2xl:pr-40 text-end">
            <h1 className="text-7xl md:text-9xl lg:text-[170px] 2xl:text-[180px] text-lm_icons font-bold">THE HUB<br />DAO <br /> FAMILY</h1>
          </div>
        </div>
