...
export default function Soon() {
  return (
    <div className='flex justify-center items-center w-full h-screen text-white relative bg-[url("/bg.jpg")] bg-cover bg-center bg-no-repeat'>
      ...
      <div className='flex flex-col justify-center items-center relative h-fit'>
        <h1 className='font-humane text-9xl lg:text-[320px] leading-[0.7] text-[#54575C]'>COMING SOON</h1>
        <p className="font-medium text-base lg:text-xl text-[#54575C] text-center">we are still buidling this view<br />in the meantime, PLEASE STAY IN TOUCH  :)</p>
