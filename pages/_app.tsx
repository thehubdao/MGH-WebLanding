...
import NeuePlakExtended from '@next/font/local';
...
const neuePlakExtended = NeuePlakExtended({src: '../styles/fonts/Neue-Plak-Extended-Black.ttf', style: 'normal', weight:'900', display: 'block'});
      ...
      <style jsx global>
        {`
          :root {
            ...
            --neue-extended-font : ${neuePlakExtended.style.fontFamily};
          }
        `}
      </style>
      <DefaultLayout>
