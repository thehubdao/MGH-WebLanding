    ...
    <>
      <main className="px-10 lg:px-60 pt-28 lg:pt-60 pb-20 font-work">
        ...
        <p className="font-light text-base lg:text-2xl text-center leading-relaxed pt-16">
          At THE HUB, accessible from https://thehubdao.xyz, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by THE HUB and how we use it.
          If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.
          This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in THE HUB. This policy is not applicable to any information collected offline or via channels other than this website.
        </p>
        ...
        <p className="font-light text-base lg:text-2xl leading-relaxed pt-11">
          ...
          Note that THE HUB has no access to or control over these cookies that are used by third-party advertisers.
        </p>
        <h2 className="font-poppins font-medium text-[42px] pt-32">Third Party Privacy Policies</h2>
        <p className="font-light text-base lg:text-2xl leading-relaxed pt-11">
          THE HUB&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt out of certain options.
        ...
        <p className="font-light text-base lg:text-2xl leading-relaxed pt-11 pb-60">
          ...
          THE HUB does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.
        </p>
      </main>
    </>
  )
